...
plot_boxplot_fromdf_wseaborn_to_ax(df,"DH",box_by= "set_name",ax=axarr[0],index="A",ylabel= "sigmaK_norm",points=True)

plot_boxplot_fromdf_wseaborn_to_ax(df_rnd_zscore,"DH",box_by= "set_name",index="C",ylabel= "sigmaK_norm_Zscore",points=True, significance_lines=True,ax=axarr[1])
axarr[1].tick_params(labelsize=14,labelrotation=30)

filename="../OUTPUT/Images/DH_by_set.pdf"
plt.tight_layout()
...
Table_filename="../OUTPUT/Data/Table_S2.tex"
